...
const Dashboard = () => {
  ...
  const links = [
    ...
    { name: "Insurance", href: "/dashboard-insurance", icon: <FaShieldAlt size={20}/> },
    { name: "Traffic Code", href: "/dashboard-trafic-code", icon: <MdTraffic size={22}/> },
  ];
  ...
  <div className="relative">
    <button
      ...
      className="flex items-center space-x-2 px-3 py-2 rounded-2xl border-2 border-[#303481]
      shadow-md shadow-[#303481] hover:border-[#FFF200] transition-all"
    >
      <FaUserCircle className="text-2xl text-[#303481]" />
      <span className="hidden lg:block text-[#303481] font-semibold">
        My Account
      </span>
    </button>

    {showUserMenu && (
      <div className="absolute right-0 mt-3 w-48 bg-white rounded-xl border-2 border-[#303481]
      shadow-lg z-50 overflow-hidden">
        ...
        <button
          ...
          className="w-full flex items-center space-x-2 px-4 py-3 hover:bg-[#F5F5F5]"
        >
          <FiSettings />
